...
public class DriveBase extends SubsystemBase {
  ...
  private final DifferentialDrive m_drive = new DifferentialDrive(m_motorLeft1, m_motorRight1);
  ...
  public DriveBase(boolean forward) {
    ...
    AutoDriveBaseTab.add("kP1", kP1).getEntry().addListener(notification -> {
      m_motorLeft1.config_kP(0, notification.value.getDouble());
    }, EntryListenerFlags.kUpdate);
    AutoDriveBaseTab.add("kI1", kI1).getEntry().addListener(notification -> {
      m_motorLeft1.config_kI(0, notification.value.getDouble());
    }, EntryListenerFlags.kUpdate);
    AutoDriveBaseTab.add("kD1", kD1).getEntry().addListener(notification -> {
      m_motorLeft1.config_kD(0, notification.value.getDouble());
    }, EntryListenerFlags.kUpdate);
    AutoDriveBaseTab.add("kF1", kF1).getEntry().addListener(notification -> {
      m_motorLeft1.config_kF(0, notification.value.getDouble());
    }, EntryListenerFlags.kUpdate);
